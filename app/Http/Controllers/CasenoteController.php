...
class CasenoteController extends defaultController
{
    ...
    public function index(Request $request){ 
        ...
        return view('casenote',compact('centers'));
    }
