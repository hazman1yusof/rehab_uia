    ...
    public function save_pt(Request $request){
        ...
        try {
            ...
            foreach ($add_array as $key => $value) {
                ...
                }else if(str_starts_with($key, 'epis_')){
